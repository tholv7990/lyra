...
export enum ActionType { Brand = 'brand', Crawl = 'crawl', Publish = 'publish', UnitEcon = 'unit-econ', Evaluate = 'evaluate', SaveProduct = 'save-product', Score = 'score', DemandGate = 'demand-gate', ResolveInputs = 'resolve-inputs', Competition = 'competition', RiskScreen = 'risk-screen' }
