...
const ctx = (over: any = {}) => ({ action: { type: 'save-product' }, step: {} as any, workspaceId: 'ws', productId: 'noProductId' in over ? over.noProductId : 'p1', priorResults: [],
  ledger: { evidence: [{ id: 'c1', statement: 'a', kind: 'estimate', sourceId: 's1', quote: 'a' }], sources: [{ id: 's1', name: 'S', url: 'u', accessDate: 'd', primary: false, alive: true }], econInputs: { aov: 50, landedCost: 12, paymentFeePct: 0.03, fulfillment: 4, shippingSubsidy: 2, expectedReturnLossPct: 0.05, warrantyReservePct: 0, desiredPostAdCmPct: 0.15 }, data: { unitEcon: { cm1: 5 }, score: 80, grade: 'B', decision: 'TEST_NOW', subScores: {}, hardGates: { unresolvedSafety: false, materialIpRisk: false, negativeUnitEcon: false, cpaExceedsMaxCac: false, singleSourceDemand: false, misleadingClaimsRequired: false }, assumptions: ['Assumed AOV $30'], competition: { competitors: [], marketType: 'emerging' } }, variables: {} } }) as any;
