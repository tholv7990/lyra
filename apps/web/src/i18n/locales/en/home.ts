export default {
  ...
  exploreLabel: 'Explore Lyra',
  keysAction: 'Action needed',
  wsTypePersonal: 'Personal workspace',
  wsTypeTeam: 'Team workspace',
  roleOwner: 'Owner',
  roleMember: 'Member',
  roleViewer: 'Viewer',
  chatsTitle: 'Chats',
  ...
  confirmEmailBody: 'We sent a confirmation link to {{email}}. Confirm it to unlock the full workspace.',
  confirmEmailResend: 'Resend email',
  confirmEmailSent: 'Sent ✓',
