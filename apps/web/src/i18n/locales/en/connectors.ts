export default {
  ...
  firecrawl: 'Robust fetch (Firecrawl)',
  firecrawlKeyHint: 'Optional. A Firecrawl key lets Lyra fetch bot-blocked marketplace pages (Amazon, AliExpress, Walmart). 1,000 free pages/month.',
