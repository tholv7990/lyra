export default {
  ...
  gatedSub: 'Review the output before the flow saves it and continues.',
  ...
  fillVariables: 'Fill the variables this flow uses — they resolve into every step prompt.',
  ...
  saveToPipeline: 'Save to flow',
  model: 'Model',
  savedToPipelineConfirm: 'Saved to the flow — future runs use this prompt.',
