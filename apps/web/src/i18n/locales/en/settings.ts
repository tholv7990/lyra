export default {
  ...
  requestProviderNameLabel: 'Provider name',
  requestProviderName: 'e.g. Together AI',
  requestProviderNoteLabel: 'Note (optional)',
  requestProviderNote: "Why you'd like it, a link, anything.",
