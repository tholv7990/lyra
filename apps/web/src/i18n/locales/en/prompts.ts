export default {
  ...
  history: 'History',
  historyEmpty: 'No runs yet — open it in chat to start its history.',
  historyMessages: '{{count}} message',
  historyMessages_other: '{{count}} messages',
  openThisChat: 'Open this chat',
  ...
  writeHint: 'Type below — a live preview renders here.',
  variables: 'Variables',
