export default {
  ...
  exploreLabel: 'Khám phá Lyra',
  keysAction: 'Cần thiết lập',
  wsTypePersonal: 'Workspace cá nhân',
  wsTypeTeam: 'Workspace nhóm',
  ...
  gsExpand: 'Mở rộng',
  gsStepDone: 'Xong',
  confirmEmailTitle: 'Xác nhận email của bạn',
  confirmEmailBody: 'Chúng tôi đã gửi liên kết xác nhận tới {{email}}. Xác nhận để mở khóa toàn bộ workspace.',
  confirmEmailResend: 'Gửi lại email',
  confirmEmailSent: 'Đã gửi ✓',
