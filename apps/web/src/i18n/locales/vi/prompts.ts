export default {
  ...
  history: 'Lịch sử',
  historyEmpty: 'Chưa có lần chạy nào — mở trong chat để bắt đầu lịch sử.',
  historyMessages: '{{count}} tin nhắn',
  historyMessages_other: '{{count}} tin nhắn',
  openThisChat: 'Mở chat này',
