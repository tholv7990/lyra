export default {
  ...
  tavilyKey: 'Khóa tìm kiếm Tavily',
  tavilyKeyHint: 'Cấp năng lượng cho tìm kiếm nghiên cứu sản phẩm có dẫn nguồn.',
  firecrawl: 'Tải trang mạnh (Firecrawl)',
  firecrawlKeyHint: 'Tuỳ chọn. Khoá Firecrawl giúp Lyra tải các trang sàn bị chặn bot (Amazon, AliExpress, Walmart). 1.000 trang miễn phí/tháng.',
  firecrawlKey: 'Khoá API Firecrawl',
  update: 'Cập nhật',
  save: 'Lưu',
