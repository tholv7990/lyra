    ...
    >
      <form className="ap-form" onSubmit={(e) => void handleSubmit(e)}>
        ...
        <section className="ap-section">
          <div className="ap-section-label">{t('products.panelProduct')}</div>
        ...
        {/* Pricing */}
        <section className="ap-section">
          <div className="ap-section-label">{t('products.panelPricing')}</div>
          <div className="fields-grid">
            <label className="field">
        ...
        {/* Sourcing & media */}
        <section className="ap-section">
          <div className="ap-section-label">{t('products.panelSourcing')}</div>
          <label className="field full">
          ...
          <label className="field full">
            ...
            <textarea className="text-input" value={images} onChange={(e) => setImages(e.target.value)} placeholder={'https://…/front.jpg\nhttps://…/side.jpg'} rows={3} style={{ resize: 'vertical' }} />
          </label>
        </section>
